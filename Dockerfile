...
perl-dev gcc musl-dev libxml2-dev make linux-headers imagemagick-dev jpeg-dev lcms2-dev fontconfig-dev freetype-dev \
...
cpanm --force XML::LibXML XML::XML2JSON Redis::Fast && \
cd /tmp && \
